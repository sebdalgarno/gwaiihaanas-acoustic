...
```{r anmu.temp.ph1)}
tempcov_baci(data = filter(sea, phase1 == 1 & species == sp[1]), x = 'night', y = 'siteID', color = 'exp', date.start = y.window[1,2], date.end = y.window[1,3])
```
  
`r figs("anmu.temp.ph2")`

```{r anmu.temp.ph2)}
tempcov_baci(data = filter(sea, phase2 == 1 & species == sp[1]), x = 'night', y = 'siteID', color = 'exp', date.start = y.window[1,2], date.end = y.window[1,3])
```
...
```{r caau.temp.ph1)}
tempcov_baci(data = filter(sea, phase1 == 1 & species == sp[2]), x = 'night', y = 'siteID', color = 'exp', date.start = y.window[2,2], date.end = y.window[2,3])
```
  
`r figs("caau.temp.ph2")`

```{r caau.temp.ph2)}
tempcov_baci(data = filter(sea, phase2 == 1 & species == sp[2]), x = 'night', y = 'siteID', color = 'exp', date.start = y.window[2,2], date.end = y.window[2,3])
```
...
```{r ftsp.temp.ph1)}
tempcov_baci(data = filter(sea, phase1 == 1 & species == sp[3]), x = 'night', y = 'siteID', color = 'exp', date.start = y.window[3,2], date.end = y.window[3,3])
```
  
`r figs("ftsp.temp.ph2")`

```{r ftsp.temp.ph2)}
tempcov_baci(data = filter(sea, phase2 == 1 & species == sp[3]), x = 'night', y = 'siteID', color = 'exp', date.start = y.window[3,2], date.end = y.window[3,3])
```
