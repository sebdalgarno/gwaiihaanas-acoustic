...
Task 2a) Describe seabird and songbird data coverage in space and time with appropriate plots
...
# Vocalization rates
Task 2c) Describe the annual and nightly variation in seabird vocalization (proportion of recordings with presence, and proportion of recordings with presence of multiple individuals), by species (appropriate figures such as box plots).
