...
figs("anmu.mean.ph1", "Phase 1, Ancient Murrelet; Mean logit(proportion) of recordings with detected presence (left panel) and more than one individual detected (right panel).")
...
figs("caau.mean.ph1", "Phase 1, Cassin's Auklet; Mean logit(proportion) of recordings with detected presence (left panel) and more than one individual detected (right panel).")
...
figs("ftsp.temp.ph2", paste("Phase 1 temporal coverage by site within 14-day sampling window",
                            ' ', '(', month(y.window[3,2], label = TRUE),'-', day(y.window[3,2]), ' - ', month(y.window[3,3], label = TRUE), '-',  day(y.window[3,3]), ')',
                            "; ", "Fork-Tailed Storm Petrel.", sep = ''))
figs("ftsp.mean.ph1", "Phase 1, Fork-Tailed Storm-Petrel; Mean logit(proportion) of recordings with detected presence (left panel) and more than one individual detected (right panel).")
